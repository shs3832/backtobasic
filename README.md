...
| accordion-ui/study01 | 아코디언 UI - HTML/SCSS | 완료 | [study-summary.md](./accordion-ui/study01/study-summary.md) |
...
## Accordion UI Study 01 - HTML/SCSS

FAQ 아코디언 UI의 HTML 구조와 카드형 SCSS 스타일을 작성했습니다.
...
- 아코디언 JavaScript 클릭 토글 구현
- FAQ 정책상 여러 개 동시 열림을 허용할지, 하나만 열리게 할지 결정
- `aria-expanded`와 패널 `hidden`을 함께 갱신하는 흐름 연습
